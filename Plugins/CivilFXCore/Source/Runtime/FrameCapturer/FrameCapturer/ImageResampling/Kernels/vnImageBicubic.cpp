...
VN_STATUS vnBicubicKernel( CONST CVImage & pSrcImage, FLOAT32 fCoeffB, FLOAT32 fCoeffC, FLOAT32 fX, FLOAT32 fY, BOOL bDirection, UINT8 * pRawOutput )
{
    ...
    switch ( bDirection )
    {
        case true: return vnSampleBicubicHorizontal( pSrcImage, fCoeffB, fCoeffC, fX, fY, pRawOutput );
        case false: return  vnSampleBicubicVertical( pSrcImage, fCoeffB, fCoeffC, fX, fY, pRawOutput );
    }
